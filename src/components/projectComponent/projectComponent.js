...
const mockDataTwo = [
  ...
  {
    projectTitle: 'Pokémon TCG',
    projectText: 'A webapp dedicated to showing information about Pokémon Trading Cards using Pokémon TCG API and Involvement API.9',
    projectClass: 'projectFour inner-content d-flex flex-column justify-content-end p-1',
    firstButton: 'HTML & CSS',
    secondButton: 'Webpack',
    thirdButton: 'API',
    fourthButton: 'JavaScript',
    projectLink: 'https://github.com/tiagorahal/pokemon-tcg',
    keys: 'four',
  },
